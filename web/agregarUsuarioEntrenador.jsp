...
<html>
    ...
    <body>        
        ...
        <header>
         ...
         <div align="center">
             <img src="img/entrenador.jpg" width="400" align="center" alt="No se pudo mostrar la imagen" border=0 hspace="20">
         </div> 
            <br><br>
                                  
        <h5 align="center">PARA AGREGAR UN ENTRENADOR COMPLETA LOS SIGUIENTES CAMPOS:</h5>        
            
        <form action="ServletGUIAgregarUsuario" method="post">                                
